    ...
    return ( 
        <div className='container-fluid mt-5 border'>
            <div className='row bg-light p-2'>
                <div className='col-3'>  
                    <img src="media/image/logo.svg" style={{width:"30%"}}/>
                    <p className='text-muted small mt-2'>
                        &copy; Zerodha Private Limited <br/>All rights reserved
                    </p>
                </div>
                <div className='col-3'>
                    <p>Company</p>
